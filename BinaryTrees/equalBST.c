...
bool equalBST(struct TreeNode* r1, struct TreeNode* r2){
    if(r1 == NULL && r2 == NULL)
        return true;
    if(r1==NULL || r2==NULL)
        return false;
    ...
    bool sub1 = equalBST(r1->left, r2->left);
    bool sub2 = equalBST(r1->left, r2->left);
    return (sub1 && sub2);
}
